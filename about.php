...
<section class="breadcrumbs">
    <div class="breadcrumb-sm-images">
        <div class="inner-banner-1 magnetic-item">
            <img src="assets/img/inner-pages/inner-banner-2.png" alt="About TASM A Five Solutions">
        </div>
        <div class="inner-banner-2 magnetic-item">
            <img src="assets/img/inner-pages/inner-banner-1.png" alt="IT Company Banner">
        </div>
    </div>
            ...
            <div class="col-12">
                <div class="breadcrumb-wrapper">
                    <div class="breadcrumb-cnt">
                        ...
                        <h1>About TasmaFive Solutions</h1>

                        <div class="breadcrumb-list">
                            <a href="index.php">Home</a>
                            <img src="assets/img/inner-pages/breadcrumb-arrow.svg" alt="">
                            About Us
                        </div>
...
<div class="home3-about-section sec-mar">
    <div class="container-fluid">
        <div class="row g-lg-4 gy-5">
            ...
            <!-- LEFT CONTENT -->
            <div class="col-lg-9">
                <div class="section-title-3 wow animate fadeInUp">
                    <h2>Our Approach</h2>
                    <p>We follow a strategic and result-driven approach to deliver innovative IT solutions that help
                        businesses grow, scale, and succeed in the digital world.</p>
                </div>

                <div class="about-left">
                    <div class="about-img wow animate fadeInUp">
                        <img class="img-fluid magnetic-item" src="assets/img/home-3/a1.png"
                            alt="IT Solutions">
                    </div>

                    <div class="about-content wow animate fadeInUp">
                        <h2>Unlock the full potential of your business.</h2>

                        <p>At Tasmafive Solutions, we understand your business needs and provide customized, scalable,
                            and future-ready solutions that deliver real results.</p>
                        ...
                        <ul class="about-feature">
                            <li>
                                ...
                                <p>We design tailored IT solutions that align perfectly with your business goals.</p>
                            </li>

                            <li>
                                <h5>Quality & Reliability</h5>
                                <p>We ensure high performance, security, and long-term reliability in every project.</p>
                            </li>

                            <li>
                                <h5>Client-Focused Approach</h5>
                                <p>Your success is our priority, and we work closely with you at every step.</p>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="col-lg-3">
                <div class="about-right">
                    ...
                    <div class="about-img wow animate fadeInUp">
                        <img class="img-fluid magnetic-item" src="assets/img/home-3/a2.png"
                            alt="Company Experience">
                    </div>

                    <div class="about-exprience d-flex align-items-center justify-content-center wow animate fadeInUp">
                        <div class="exp-text">
                            <img src="assets/img/home-3/rotate-text.png" alt="Trusted IT Company">
                        </div>

                        <div class="years">
                            <h2>Top<br>Company <span>in Kanpur</span></h2>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="choose-title">
                            ...
                            <h2>Why Businesses Trust TasmaFive Solutions</h2>
                        </div>
                    </div>

                    <div class="col-lg-6">
                        <div class="choose-right-img magnetic-item">
                            <img class="img-fluid" src="assets/img/home-6/choose-img-1.png" alt="IT Solutions">
                        </div>
                    </div>
                ...
                <div class="row g-lg-4 gy-5">
                    ...
                    <div class="col-lg-7">
                        <div class="choose-left-content">
                            ...
                            <div class="icon">
                                <img src="assets/img/tafv.svg" alt="TASM Logo">
                            </div>

                            <h4>Trusted IT Solutions Partner <br>
                                <span>Delivering Innovation & Results</span>
                            </h4>

                            <p>We deliver high-quality, scalable, and secure IT solutions that help businesses grow
                                faster, improve efficiency, and stay ahead in the digital era.</p>
                            ...
                            <div class="about-btn">
                                <a href="about.php">
                                    <svg width="7" height="7" viewBox="0 0 13 13">
                            ...
                            <ul>
                                ...
                                <li>
                                    <div class="single-feature">
                                        ...
                                        <div class="content">
                                            ...
                                            <p>We consistently deliver high-quality solutions that exceed client
                                                expectations.</p>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="single-feature">
                                        ...
                                        <div class="content">
                                            ...
                                            <p>We ensure timely delivery and successful execution of every project.</p>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="single-feature">
                                        ...
                                        <div class="content">
                                            <h4>Business Growth Impact</h4>
                                            <p>Our solutions help businesses improve performance and achieve measurable
                                                growth.</p>
                                        </div>
                                    </div>
                                </li>
        ...
        <div class="row g-xl-4 gy-5">
            <div class="col-xl-3 wow animate fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                <div class="section-title-4">
                    ...
                    <p>We deliver reliable IT solutions with proven results, helping businesses grow and succeed in the
                        digital world.</p>
                </div>
        ...
        <div class="row mb-55 wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
            <div class="col-lg-12 d-flex align-items-center justify-content-between gap-4 flex-wrap">
                <div class="section-title-3">
                    ...
                    <p>We take pride in delivering high-quality IT services, including website development, software
                        solutions, digital marketing, and government tender projects. Our clients trust us for reliable,
                        affordable, and result-driven solutions.</p>
                </div>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="testimonial-card3">
                                ...
                                <div class="testimonial-content">
                                    <p>“Tasma Five Solutions ne hamare business ke liye ek professional website develop
                                        ki. Unka kaam time par complete hua aur support bhi bahut accha mila. Highly
                                        recommended for web development.”</p>
                                </div>
                                ...
                                <div class="testimonial-btm">
                                    <div class="author-area">
                                        <div class="author-content">
                                            <h4>Rohit Sharma</h4>
                                            <span>Small Business Owner, Kanpur</span>
                                        </div>
                                    </div>
                            ...
                            <div class="author-img">
                                <img src="assets/img/avtar/4.png" alt="">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="testimonial-card3">
                                ...
                                <div class="testimonial-content">
                                    <p>“Inhone hamara Google Ads aur SEO manage kiya, jisse hamari website par traffic
                                        aur leads dono increase hue. Professional team hai aur result-oriented kaam
                                        karti hai.”</p>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-card3">
                                ...
                                <div class="testimonial-content">
                                    <p>“Government tender related project me inhone hume complete technical support
                                        diya. Documentation se lekar execution tak sab smoothly handle kiya.”</p>
                                </div>
                            ...
                            <div class="author-img">
                                <img src="assets/img/avtar/6.png" alt="">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="testimonial-card3">
                                ...
                                <div class="testimonial-content">
                                    <p>“Budget-friendly pricing me itni acchi service milna mushkil hai. Website design
                                        aur maintenance dono hi best quality ke mile.”</p>
                                </div>
                            ...
                            <div class="author-img">
                                <img src="assets/img/avtar/2.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
...
<section class="team-clean py-5">
    <div class="container">

        <!-- TITLE -->
        <div class="text-center mb-5">
            <h2 class="fw-bold">Our <span>Team</span></h2>
            <p class="text-white">Meet our experienced professionals behind success.</p>
        </div>
...
<style>
.team-clean {
    background: linear-gradient(135deg, #0e1015b5, #16181d90);
    color: #fff;
}
...
.team-box:hover {
    ...
    background: linear-gradient(135deg, #b47b0a, #ffa006);
    color: #fff;
            ...
            <div class="col-lg-12">
                <div class="contact-wrapper text-center">
                    <h2 class="marquee_text">
                        We Manage Your IT & Digital Growth, So You Can Focus on Your Business Success.
                    </h2>
